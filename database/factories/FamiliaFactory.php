...
class FamiliaFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'declaracao_autonomo' => $this->faker->file('/tmp',storage_path('app/public/familias/faker'),true),
            'declaracao_agricultor' => $this->faker->file('/tmp',storage_path('app/public/familias/faker'),true),
