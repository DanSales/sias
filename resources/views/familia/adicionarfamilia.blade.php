            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input class="form-control-file" type="file" name="declaracao_agricultor" id="declaracao_agricultor" @error('declaracao_agricultor') is-invalid @enderror" value ="{{ old('declaracao_agricultor')}}"/><br/>
